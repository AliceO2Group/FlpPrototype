...
DEFINE_ERRINFO(CardType, ::AliceO2::ReadoutCard::CardType::type);
...
DEFINE_ERRINFO(LoopbackMode, ::AliceO2::ReadoutCard::LoopbackMode::type);
...
DEFINE_ERRINFO(PciAddress, ::AliceO2::ReadoutCard::PciAddress);
...
DEFINE_ERRINFO(PciId, ::AliceO2::ReadoutCard::PciId);
DEFINE_ERRINFO(PciIds, std::vector<::AliceO2::ReadoutCard::PciId>);
...
DEFINE_ERRINFO(ResetLevel, ::AliceO2::ReadoutCard::ResetLevel::type);
...
std::string to_string(const AliceO2::ReadoutCard::ErrorInfo::CardType& e);
std::string to_string(const AliceO2::ReadoutCard::ErrorInfo::Message& e);
std::string to_string(const AliceO2::ReadoutCard::ErrorInfo::LoopbackMode& e);
std::string to_string(const AliceO2::ReadoutCard::ErrorInfo::PciAddress& e);
std::string to_string(const AliceO2::ReadoutCard::ErrorInfo::PciId& e);
std::string to_string(const AliceO2::ReadoutCard::ErrorInfo::PciIds& e);
std::string to_string(const AliceO2::ReadoutCard::ErrorInfo::PossibleCauses& e);
std::string to_string(const AliceO2::ReadoutCard::ErrorInfo::ReadyFifoStatus& e);
std::string to_string(const AliceO2::ReadoutCard::ErrorInfo::ResetLevel& e);
std::string to_string(const AliceO2::ReadoutCard::ErrorInfo::StatusCode& e);
